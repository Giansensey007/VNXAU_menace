...
\begin{document}
\color{ink}
{\fontsize{16}{18}\selectfont\bfseries\color{primary} VNXAU Menace --- Loop Routes}~{\fontsize{10}{12}\selectfont\textcolor{ink!55}{(VNXAU)}}\\[1pt]
{\fontsize{8.5}{10.5}\selectfont Platform-first treasury · same-asset round trips · VNXAU held on VNX · chains hold hub stables only}\\[1pt]
{\fontsize{6.8}{8.2}\selectfont\textcolor{ink!55}{2026-06-20 19:13 UTC · docs/vnxau-menace-routes-executive.pdf · generated from src/scanner/routes.active\_loops()}}
...
\fcolorbox{primary!25}{surface}{\begin{minipage}[c][11mm][c]{0.9\linewidth}\statlabel{Bridges}{\fontsize{7}{8.5}\selectfont\bfseries CCTP · direct (ETH)}\end{minipage}} \\
\end{tabular}
\vspace{1.6mm}\noindent\rule{\linewidth}{0.3pt}\vspace{1.5mm}
...
\stepnum{3}~Bridge stable \textbf{X $\rightarrow$ ETH hub} \textit{(skipped if X = ETH)}\\[0.5mm]
...
\stepnum{3}~Bridge stable \textbf{ETH $\rightarrow$ chain X} \textit{(skipped if X = ETH)}\\[0.5mm]
...
1 & Loop 1 · Outbound & Base & \bridgebadge{CCTP}{routeb} \\
2 & Loop 2 · Inbound & Base & \bridgebadge{CCTP}{routeb} \\
3 & Loop 1 · Outbound & Ethereum & \bridgebadge{direct (ETH)}{profit} \\
4 & Loop 2 · Inbound & Ethereum & \bridgebadge{direct (ETH)}{profit} \\
5 & Loop 1 · Outbound & Solana & \bridgebadge{CCTP}{routeb} \\
6 & Loop 2 · Inbound & Solana & \bridgebadge{CCTP}{routeb} \\
7 & Loop 3 · Cross & Base $\rightarrow$ Ethereum & \bridgebadge{CCTP}{routeb} \\
8 & Loop 3 · Cross & Base $\rightarrow$ Solana & \bridgebadge{CCTP}{routeb} \\
9 & Loop 3 · Cross & Ethereum $\rightarrow$ Base & \bridgebadge{CCTP}{routeb} \\
10 & Loop 3 · Cross & Ethereum $\rightarrow$ Solana & \bridgebadge{CCTP}{routeb} \\
11 & Loop 3 · Cross & Solana $\rightarrow$ Base & \bridgebadge{CCTP}{routeb} \\
12 & Loop 3 · Cross & Solana $\rightarrow$ Ethereum & \bridgebadge{CCTP}{routeb} \\
...
\node[anchor=west] at(0,-5.0){\bridgebadge{direct (ETH)}{profit}};\node[anchor=west,font=\fontsize{6.6}{8}\selectfont]at(19,-5.0){No bridge --- USDC already on ETH};
\end{tikzpicture}
\end{minipage}
\vfill
