...
ROUTE_FLOWS: dict[str, tuple[str, list[tuple[str, str, str, str | None]]]] = {
    ...
    "base_to_vnx": (
        "base$\\rightarrow$vnx (off)",
        [
            ("hub_base", "Base", "USDC", None),
            ("act", "off", "no buy", None),
            ("hub_eth", "ETH", "USDC", "WH+swap"),
            ("hub_vnx", "VNX", "USDC", "VNX"),
        ],
    ),
    "vnx_to_base": (
        "vnx$\\rightarrow$base",
        [
            ...
            ("act", "Kyber", "sell VNXAU", "Kyber"),
            ("hub_base", "Base", "USDC", None),
        ],
    ),
    "ethereum_to_vnx": (
        "eth$\\rightarrow$vnx (off)",
        [
    ...
    "solana_to_vnx": (
        "sol$\\rightarrow$vnx (off)",
        [
            ("hub_sol", "Sol", "USDC", None),
            ("act", "off", "no buy", None),
            ("hub_eth", "ETH", "USDC", "CCTP"),
            ("hub_vnx", "VNX", "USDC", "VNX"),
        ],
    ),
    "vnx_to_solana": (
        ...
        [
            ...
            ("act", "Platform", "buy VNXAU", "VNX"),
            ("hub_vnx", "VNX", "withdraw", "VNX"),
            ("act", "Jupiter", "sell VNXAU", "Jupiter"),
            ("hub_sol", "Sol", "USDC", None),
